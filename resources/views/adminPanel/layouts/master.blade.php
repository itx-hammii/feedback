...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('adminPanel/bootstrap/css/app.css') }}">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{asset('adminPanel/images/user1-128x128.jpg')}}" class="img-circle elevation-2" alt="User">
                </div>
                <div class="info">
            ...
            <!-- Sidebar Menu -->
            @include('adminPanel.layouts.includes.leftSideBar')
            <!-- /.sidebar-menu -->
        </div>
        <!-- /.sidebar -->
    </aside>
...
@include('adminPanel.layouts.script')
@yield('scripts')
</body>
